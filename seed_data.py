...
This file contains all the swimming locations for Berlin that should be available in the Squalo webapp.
"""

# All Squalo swim locations (30+ locations)
# This list includes both existing and new locations to ensure comprehensive coverage
SWIM_LOCATIONS = [
    # Core Berlin locations (23 from original request)
    {
