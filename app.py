...
SHOP_PRODUCTS = [
    # ── Schwimmbrillen ──
    {
        ...
        "image": "images/shop/arena-cobra-gold-goggles.png",
        "price": 45.0,
        "note": "",
    },
    {
    ...
    },
    {
        ...
        "image": "images/shop/kickboard-blue.png",
        "price": 10.0,
        "note": "",
    },
]
    ...
    with app.app_context():
        ...
        if existing_coach_tolga:
            ...
            existing_coach_tolga.bio = (
                ...
                "bringen möchten. Durch über zehn Jahre Erfahrung im leistungsorientierten "
                "Schwimmen, unter anderem bei den Berliner Wasserratten 1889 e.V. und dem "
                "Schwimmclub Wedding, kennt er die Details, die im Wasser wirklich einen "
                "Unterschied machen: saubere Wasserlage, effizienter Armzug, kraftvolle "
                "Starts, präzise Wenden und ein klarer Trainingsaufbau.\n\n"
                ...
                "erfahrenen und präzisen Coach, der mit professionellen Trainingsmethoden "
                "arbeitet und seine Schüler fordert, um ihr volles Potenzial im Wasser "
                "auszuschöpfen.\n\n"
                ...
                "türkischer Sprache wohler fühlen. Bei gutem Wetter trainiert Tolga "
                "bevorzugt am Plötzensee. Alternativ ist er besonders für Training im "
                "Kombibad Seestraße verfügbar."
            )
            existing_coach_tolga.strengths = (
                "• Über zehn Jahre Erfahrung im leistungsorientierten Schwimmen\n"
                "• Erfahrung bei den Berliner Wasserratten 1889 e.V. und dem Schwimmclub Wedding\n"
            ...
            existing_coach_tolga.swim_style = (
                ...
                "Dabei arbeitet Tolga mit professionellen Trainingsmethoden aus dem "
                "leistungsorientierten Schwimmen. Er fordert seine Schüler gezielt, "
                "achtet auf technische Details und setzt klare Trainingsimpulse, damit "
                "sie ihre Leistung verbessern und ihr volles Potenzial im Wasser "
                "ausschöpfen können.\n\n"
                "Für ambitionierte Schwimmer kann der Fokus auch auf wettkampfnahen "
                "Themen liegen: Start, Wende, Atemrhythmus, Tempoaufbau und "
                "Belastungssteuerung. Das Coaching bleibt dabei klar und direkt "
                "verständlich – auf Deutsch oder auf Türkisch."
            )
            existing_coach_tolga.experience = (
                "🏅 Über zehn Jahre Schwimmerfahrung im leistungsorientierten Bereich\n"
                "🏅 Erfahrung bei den Berliner Wasserratten 1889 e.V. und dem Schwimmclub Wedding\n"
                "🏅 Erfahrung im Berliner Vereinsschwimmen\n"
                "🏅 Wettkampferfahrung\n"
                "🏅 Techniktraining für Fortgeschrittene\n"
                "🏅 Kraultechnik, Starts, Wenden und Leistungsaufbau\n"
                "🏅 Rettungsschwimmer\n"
